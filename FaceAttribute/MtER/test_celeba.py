...
from image_dataset import MyDataset
...
parser.add_argument('--eval_ckpt', default="/home/xuujie_ygc/workspace/MM_FOR_ML/FaceAttritube/Simple/weight/model/SIMPLE_MTL_CELEBA_model_best.pth",
...
parser.add_argument('--arch', default='SIMPLE_MTL_CELEBA2', type=str, help='model type for train')
