...
class ConvNeXt(nn.Module):
    ...
    def __init__(self, in_chans=3, num_classes=1000,
        ...
        self.attention = DSAttention(dim=dims[-1], kernel_size=7)
...
def convnext_base(pretrained=False, **kwargs):
    ...
    if pretrained:
        checkpoint = torch.load('F:\ImageClassification\Templates\models\pretrain\convnext_base.pth', map_location='cpu')['state_dict']
